  ...
  return (
    ...
    "bg-n-8" : "bg-n-8/90 backdrop-blur-sm"}`}>
        ...
        <div className="flex items-center px-5 lg:px-7.5 xl:px-10 max-lg:py-4">
            ...
            <a className="block w-[12rem] xl:mr-8" href="#hero7">
            <img src = {logo} width={190} 
            height={40}  alt= "QuantumVibes"/>
        </a>
        
        <nav 
        className={` ${openNavigation ? "flex" : "hidden"} fixed top-[5rem] left-0 
        ...
        <a href="#signup" className="button hidden
        mr-8 text-n-1/50 transition-colors hover:text-n-1 lg:block">
            New Account </a>
            ...
            px="px-3" onClick={toggleNavigation}>
